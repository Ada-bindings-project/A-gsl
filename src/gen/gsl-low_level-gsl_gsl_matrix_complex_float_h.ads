...
package GSL.Low_Level.gsl_gsl_matrix_complex_float_h is
  ...
  -- Operations  
   ...
   function gsl_matrix_complex_float_fread (stream : Interfaces.C_Streams.FILEs; m : access gsl_matrix_complex_float) return int  -- /usr/include/gsl/gsl_matrix_complex_float.h:212
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_complex_float_fread";

   function gsl_matrix_complex_float_fwrite (stream : Interfaces.C_Streams.FILEs; m : access constant gsl_matrix_complex_float) return int  -- /usr/include/gsl/gsl_matrix_complex_float.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_complex_float_fwrite";

   function gsl_matrix_complex_float_fscanf (stream : Interfaces.C_Streams.FILEs; m : access gsl_matrix_complex_float) return int  -- /usr/include/gsl/gsl_matrix_complex_float.h:214
   with Import => True, 
        Convention => C, 

...
package GSL.Low_Level.gsl_gsl_vector_ushort_h is
  ...
  -- Operations  
   ...
   function gsl_vector_ushort_fread (stream : Interfaces.C_Streams.FILEs; v : access gsl_vector_ushort) return int  -- /usr/include/gsl/gsl_vector_ushort.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_ushort_fread";

   function gsl_vector_ushort_fwrite (stream : Interfaces.C_Streams.FILEs; v : access constant gsl_vector_ushort) return int  -- /usr/include/gsl/gsl_vector_ushort.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_ushort_fwrite";

   function gsl_vector_ushort_fscanf (stream : Interfaces.C_Streams.FILEs; v : access gsl_vector_ushort) return int  -- /usr/include/gsl/gsl_vector_ushort.h:132
   with Import => True, 
        Convention => C, 

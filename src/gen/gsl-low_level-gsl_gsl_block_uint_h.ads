...
package GSL.Low_Level.gsl_gsl_block_uint_h is
  ...
  --  
   ...
   function gsl_block_uint_fread (stream : Interfaces.C_Streams.FILEs; b : access gsl_block_uint) return int  -- /usr/include/gsl/gsl_block_uint.h:50
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_uint_fread";

   function gsl_block_uint_fwrite (stream : Interfaces.C_Streams.FILEs; b : access constant gsl_block_uint) return int  -- /usr/include/gsl/gsl_block_uint.h:51
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_uint_fwrite";

   function gsl_block_uint_fscanf (stream : Interfaces.C_Streams.FILEs; b : access gsl_block_uint) return int  -- /usr/include/gsl/gsl_block_uint.h:52
   with Import => True, 
        Convention => C, 

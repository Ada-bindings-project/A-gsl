...
package GSL.Low_Level.gsl_gsl_matrix_short_h is
  ...
  -- Operations  
   ...
   function gsl_matrix_short_fread (stream : Interfaces.C_Streams.FILEs; m : access gsl_matrix_short) return int  -- /usr/include/gsl/gsl_matrix_short.h:212
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_short_fread";

   function gsl_matrix_short_fwrite (stream : Interfaces.C_Streams.FILEs; m : access constant gsl_matrix_short) return int  -- /usr/include/gsl/gsl_matrix_short.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_short_fwrite";

   function gsl_matrix_short_fscanf (stream : Interfaces.C_Streams.FILEs; m : access gsl_matrix_short) return int  -- /usr/include/gsl/gsl_matrix_short.h:214
   with Import => True, 
        Convention => C, 

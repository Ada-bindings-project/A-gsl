...
package GSL.Low_Level.gsl_gsl_vector_int_h is
  ...
  -- Operations  
   ...
   function gsl_vector_int_fread (stream : Interfaces.C_Streams.FILEs; v : access gsl_vector_int) return int  -- /usr/include/gsl/gsl_vector_int.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_int_fread";

   function gsl_vector_int_fwrite (stream : Interfaces.C_Streams.FILEs; v : access constant gsl_vector_int) return int  -- /usr/include/gsl/gsl_vector_int.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_int_fwrite";

   function gsl_vector_int_fscanf (stream : Interfaces.C_Streams.FILEs; v : access gsl_vector_int) return int  -- /usr/include/gsl/gsl_vector_int.h:132
   with Import => True, 
        Convention => C, 

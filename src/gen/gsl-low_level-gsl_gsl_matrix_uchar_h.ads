...
package GSL.Low_Level.gsl_gsl_matrix_uchar_h is
  ...
  -- Operations  
   ...
   function gsl_matrix_uchar_fread (stream : Interfaces.C_Streams.FILEs; m : access gsl_matrix_uchar) return int  -- /usr/include/gsl/gsl_matrix_uchar.h:212
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_uchar_fread";

   function gsl_matrix_uchar_fwrite (stream : Interfaces.C_Streams.FILEs; m : access constant gsl_matrix_uchar) return int  -- /usr/include/gsl/gsl_matrix_uchar.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_uchar_fwrite";

   function gsl_matrix_uchar_fscanf (stream : Interfaces.C_Streams.FILEs; m : access gsl_matrix_uchar) return int  -- /usr/include/gsl/gsl_matrix_uchar.h:214
   with Import => True, 
        Convention => C, 

...
package GSL.Low_Level.gsl_gsl_matrix_char_h is
   ...
   function gsl_matrix_char_fread (stream : access Interfaces.C_Streams.FILEs; m : access gsl_matrix_char) return int  -- /usr/include/gsl/gsl_matrix_char.h:212
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_char_fread";

   function gsl_matrix_char_fwrite (stream : access Interfaces.C_Streams.FILEs; m : access constant gsl_matrix_char) return int  -- /usr/include/gsl/gsl_matrix_char.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_char_fwrite";

   function gsl_matrix_char_fscanf (stream : access Interfaces.C_Streams.FILEs; m : access gsl_matrix_char) return int  -- /usr/include/gsl/gsl_matrix_char.h:214
   with Import => True, 
        Convention => C, 

...
package GSL.Low_Level.gsl_gsl_vector_char_h is
  ...
  -- Operations  
   ...
   function gsl_vector_char_fread (stream : Interfaces.C_Streams.FILEs; v : access gsl_vector_char) return int  -- /usr/include/gsl/gsl_vector_char.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_char_fread";

   function gsl_vector_char_fwrite (stream : Interfaces.C_Streams.FILEs; v : access constant gsl_vector_char) return int  -- /usr/include/gsl/gsl_vector_char.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_char_fwrite";

   function gsl_vector_char_fscanf (stream : Interfaces.C_Streams.FILEs; v : access gsl_vector_char) return int  -- /usr/include/gsl/gsl_vector_char.h:132
   with Import => True, 
        Convention => C, 

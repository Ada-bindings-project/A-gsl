...
package GSL.Low_Level.gsl_gsl_vector_complex_float_h is
  ...
  -- Operations  
   ...
   function gsl_vector_complex_float_fread (stream : Interfaces.C_Streams.FILEs; v : access gsl_vector_complex_float) return int  -- /usr/include/gsl/gsl_vector_complex_float.h:150
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_complex_float_fread";

   function gsl_vector_complex_float_fwrite (stream : Interfaces.C_Streams.FILEs; v : access constant gsl_vector_complex_float) return int  -- /usr/include/gsl/gsl_vector_complex_float.h:152
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_complex_float_fwrite";

   function gsl_vector_complex_float_fscanf (stream : Interfaces.C_Streams.FILEs; v : access gsl_vector_complex_float) return int  -- /usr/include/gsl/gsl_vector_complex_float.h:154
   with Import => True, 
        Convention => C, 

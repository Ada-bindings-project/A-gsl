...
package GSL.Low_Level.gsl_gsl_matrix_long_h is
   ...
   function gsl_matrix_long_fread (stream : access Interfaces.C_Streams.FILEs; m : access gsl_matrix_long) return int  -- /usr/include/gsl/gsl_matrix_long.h:212
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_long_fread";

   function gsl_matrix_long_fwrite (stream : access Interfaces.C_Streams.FILEs; m : access constant gsl_matrix_long) return int  -- /usr/include/gsl/gsl_matrix_long.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_long_fwrite";

   function gsl_matrix_long_fscanf (stream : access Interfaces.C_Streams.FILEs; m : access gsl_matrix_long) return int  -- /usr/include/gsl/gsl_matrix_long.h:214
   with Import => True, 
        Convention => C, 

...
package GSL.Low_Level.gsl_gsl_block_complex_long_double_h is
  ...
  --  
   ...
   function gsl_block_complex_long_double_fread (stream : Interfaces.C_Streams.FILEs; b : access gsl_block_complex_long_double) return int  -- /usr/include/gsl/gsl_block_complex_long_double.h:50
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_complex_long_double_fread";

   function gsl_block_complex_long_double_fwrite (stream : Interfaces.C_Streams.FILEs; b : access constant gsl_block_complex_long_double) return int  -- /usr/include/gsl/gsl_block_complex_long_double.h:51
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_complex_long_double_fwrite";

   function gsl_block_complex_long_double_fscanf (stream : Interfaces.C_Streams.FILEs; b : access gsl_block_complex_long_double) return int  -- /usr/include/gsl/gsl_block_complex_long_double.h:52
   with Import => True, 
        Convention => C, 

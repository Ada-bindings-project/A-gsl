...
package GSL.Low_Level.gsl_gsl_matrix_long_double_h is
  ...
  -- Operations  
   ...
   function gsl_matrix_long_double_fread (stream : Interfaces.C_Streams.FILEs; m : access gsl_matrix_long_double) return int  -- /usr/include/gsl/gsl_matrix_long_double.h:212
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_long_double_fread";

   function gsl_matrix_long_double_fwrite (stream : Interfaces.C_Streams.FILEs; m : access constant gsl_matrix_long_double) return int  -- /usr/include/gsl/gsl_matrix_long_double.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_long_double_fwrite";

   function gsl_matrix_long_double_fscanf (stream : Interfaces.C_Streams.FILEs; m : access gsl_matrix_long_double) return int  -- /usr/include/gsl/gsl_matrix_long_double.h:214
   with Import => True, 
        Convention => C, 

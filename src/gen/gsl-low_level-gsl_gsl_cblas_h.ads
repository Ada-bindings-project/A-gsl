...
package GSL.Low_Level.gsl_gsl_cblas_h is
  ...
  --  
   ...
   CblasNoTrans : constant unsigned := 111;
   CblasTrans : constant unsigned := 112;
   CblasConjTrans : constant unsigned := 113;  -- /usr/include/gsl/gsl_cblas.h:47

   subtype CBLAS_UPLO is unsigned;
   CblasUpper : constant unsigned := 121;
   CblasLower : constant unsigned := 122;  -- /usr/include/gsl/gsl_cblas.h:48

   subtype CBLAS_DIAG is unsigned;
   CblasNonUnit : constant unsigned := 131;
   CblasUnit : constant unsigned := 132;  -- /usr/include/gsl/gsl_cblas.h:49
  ...
  --  
   ...
   function cblas_isamax
     (N : int;
      X : access float;
      incX : int) return size_t  -- /usr/include/gsl/gsl_cblas.h:99
   with Import => True, 
        Convention => C, 
   ...
   function cblas_idamax
     (N : int;
      X : access double;
      incX : int) return size_t  -- /usr/include/gsl/gsl_cblas.h:100
   with Import => True, 
        Convention => C, 
   ...
   function cblas_icamax
     (N : int;
      X : System.Address;
      incX : int) return size_t  -- /usr/include/gsl/gsl_cblas.h:101
   with Import => True, 
        Convention => C, 
   ...
   function cblas_izamax
     (N : int;
      X : System.Address;
      incX : int) return size_t  -- /usr/include/gsl/gsl_cblas.h:102
   with Import => True, 
        Convention => C, 
...
end GSL.Low_Level.gsl_gsl_cblas_h;

...
package GSL.Low_Level.gsl_gsl_vector_ulong_h is
   ...
   function gsl_vector_ulong_fread (stream : access Interfaces.C_Streams.FILEs; v : access gsl_vector_ulong) return int  -- /usr/include/gsl/gsl_vector_ulong.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_ulong_fread";

   function gsl_vector_ulong_fwrite (stream : access Interfaces.C_Streams.FILEs; v : access constant gsl_vector_ulong) return int  -- /usr/include/gsl/gsl_vector_ulong.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_ulong_fwrite";

   function gsl_vector_ulong_fscanf (stream : access Interfaces.C_Streams.FILEs; v : access gsl_vector_ulong) return int  -- /usr/include/gsl/gsl_vector_ulong.h:132
   with Import => True, 
        Convention => C, 

...
package GSL.Low_Level.gsl_gsl_block_short_h is
  ...
  --  
   ...
   function gsl_block_short_fread (stream : access Interfaces.C_Streams.FILEs; b : access gsl_block_short) return int  -- /usr/include/gsl/gsl_block_short.h:50
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_short_fread";

   function gsl_block_short_fwrite (stream : access Interfaces.C_Streams.FILEs; b : access constant gsl_block_short) return int  -- /usr/include/gsl/gsl_block_short.h:51
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_short_fwrite";

   function gsl_block_short_fscanf (stream : access Interfaces.C_Streams.FILEs; b : access gsl_block_short) return int  -- /usr/include/gsl/gsl_block_short.h:52
   with Import => True, 
        Convention => C, 
